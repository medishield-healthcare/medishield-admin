...
const variants = {
  base: "relative rounded-md aspect-square flex justify-center items-center flex-col cursor-pointer min-h-[150px] min-w-0 max-w-full border border-dashed border-input bg-muted/50 hover:border-primary/50 transition-colors duration-200 ease-in-out",
  image:
